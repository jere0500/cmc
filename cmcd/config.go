...
type config struct {
	...
	EventInformation   bool     `json:"eventinformation,omitempty"`
	//rename extendedInfos
...
const (
	...
	storageFlag      = "storage"
	cacheFlag        = "cache"
	eventInformationFlag   = "eventInformation"
)
...
func getConfig() (*config, error) {
	...
	eventInformation := flag.Bool(eventInformationFlag, false, "Indicates whether to include detailed information about measured events in Measurement and Verification log")
	//TODO add options
	flag.Parse()
	...
	if internal.FlagPassed(imaFlag) {
		c.EventInformation = *eventInformation
	}
...
func printConfig(c *config) {
	...
	log.Debugf("\tEvent Information        : %v", c.EventInformation)
	//TODO insert
	if c.Storage != "" {
